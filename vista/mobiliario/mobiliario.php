...
<head>  
	<script type="text/javascript">
		...
		function mostrarReporte(){
		       ...
		       formData.append("id_centro", $("#id_centro_articulo").val());
		        $.ajax({
		              //url: "http://192.168.0.16/viaticoapp/indicadores_inicio.php",
		              url: "http://centros.proyectotesisuesfmp.com/controlador/mobiliario.php",
		              type: "post",
		              dataType: "html",
		              data: formData,
		              crossDomain: true,
	    ...
	    <div class="container-fluid">
	        <div class="row page-titles" >
	            <div class="align-self-center" align="center">
	                <h3 class="text-themecolor m-b-0 m-t-0">Articulos Dañados</h3>
	            </div>
	        </div>
	                ...
	                <div class="card">
	                    ...
	                    <div class="card-body b-t">
	                    	<div class="form-group">
	                            ...
	                            <select id="id_centro_articulo" name="id_centro_articulo" class="select2" style="width: 100%">
	                            	<?php 
